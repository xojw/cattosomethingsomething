    ...
    class i extends e.EventEmitter {
        ...
        async fetch({request: i}) {
            ...
            try {
                ...
                for (const e of t)
                    f.headers[e] && delete f.headers[e];
                if (f.headers.location && (f.headers.location = c.rewriteUrl(f.headers.location)),
                ...
                return "text/event-stream" === d.headers.accept && (f.headers["content-type"] = "text/event-stream"),
                crossOriginIsolated && (f.headers["Cross-Origin-Embedder-Policy"] = "require-corp"),
                this.emit("response", b),
                b.intercepted ? b.returnValue : new Response(f.body,{
                    headers: f.headers,
                    status: f.status,
                    statusText: f.statusText
                })
            } catch (e) {
                return ["document", "iframe"].includes(i.destination) ? (console.error(e),
                function(e, t, r) {
                    let i, s, o, n, a = "";
                    !function(e) {
                    ...
                    o = e instanceof Error ? e.name : "UNKNOWN") : (i = e.status,
